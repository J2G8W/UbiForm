...
public:
    explicit SubscriberEndpoint(std::shared_ptr<EndpointSchema> receiveSchema, const std::string& endpointIdentifier = "Subscriber") :
            DataReceiverEndpoint(receiveSchema, endpointIdentifier, SocketType::Subscriber){
